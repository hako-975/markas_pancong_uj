<?php 
    ...
    if (isset($_POST['btnTambahUser'])) {
        ...
        $insert_user = mysqli_query($koneksi, "INSERT INTO user (username, nama_lengkap, no_telepon, alamat, password) VALUES ('$username', '$nama_lengkap', '$no_telepon', '$alamat', '$password_hash')");
    ...
    if (isset($_POST['btnUbahUser'])) {
        ...
        $update_user = mysqli_query($koneksi, "UPDATE user SET username = '$username', nama_lengkap = '$nama_lengkap', no_telepon = '$no_telepon', alamat = '$alamat' WHERE id_user = '$id_user_data'");
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_telepon" name="no_telepon" required value="<?= (isset($_POST['no_telepon']) ? ($_POST['no_telepon'] == '' ? $du['no_telepon'] : $_POST['no_telepon']) : $du['no_telepon']); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="alamat">Alamat<sup class="text-danger">*</sup></label>
                                            <textarea class="form-control" id="alamat" name="alamat" required><?= (isset($_POST['alamat']) ? ($_POST['alamat'] == '' ? $du['alamat'] : $_POST['alamat']) : $du['alamat']); ?></textarea>
                                        </div>
                                      </div>
